...
X_train_enc[0]
print('X_train_enc', X_train_enc[0])
...
decision_tree_best = GridSearchCV(decision_tree, best_params_, n_jobs=-1, cv=3, scoring='roc_auc')
decision_tree_best.fit(X_train_enc, Y_train)
